...
export function SupportModal({ open, onClose }: SupportModalProps) {
  ...
  return (
    <Modal
      ...
      className="flex max-h-[min(94dvh,40rem)] max-w-lg flex-col overflow-hidden rounded-t-3xl border-4 border-[#1C1917] bg-[#FFF4DF] shadow-[8px_8px_0_0_#1C1917] sm:max-h-[min(94dvh,46rem)] sm:rounded-3xl"
    >
